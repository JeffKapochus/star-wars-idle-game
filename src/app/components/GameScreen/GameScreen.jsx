...
export class GameScreen extends React.Component {
  ...
  render() {
    return (
      <div>
        <ScoreDisplay displayLabel="Galactic Credits" credits={this.state.credits}/>
        <ScoreDisplay displayLabel="Credits Per Second" credits={this.state.toAdd}/>
        <ItemButton buttonLabel="Astromech Droid" cost={0} value={1} handleClickCallback={this.buttonPressCallback} credits={this.state.credits}/>
